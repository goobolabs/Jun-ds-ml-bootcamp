...
2. **Prepare a Short Research Paper (2–3 pages)** about your dataset:
   ...
   - **Learning Type:** Is your problem **supervised** or **unsupervised**? Justify your choice based on whether you have a clear label *y* (Lesson 2).
   - **Use Case:** How could this dataset be used in a Machine Learning project (regression, classification, clustering)? Where would it fit in the **Data Science lifecycle** (Lesson 1)?
